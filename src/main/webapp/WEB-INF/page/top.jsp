    <div class="topleft">
        <a href="<%=basePath%>/front/Login_openIndex.action" target="rightFrame" style="color: white;font-size:25px;line-height:88px;margin-left:20px;text-indent: 28px;">通用病例管理系统</a>
    </div>

   <ul class="nav">
  <li><a href="<%=basePath%>/biz/SysUser_openMessage.action?id=${sessionScope.sysUser.id }&userId=${sessionScope.sysUser.userId }" target="rightFrame"><img src="images/icon01.png" title="工作台" /><h2>个人信息修改</h2></a></li>
