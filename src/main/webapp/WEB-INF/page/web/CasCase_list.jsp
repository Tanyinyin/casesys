	...
	<div class="formbody">
		<div id="usual1" class="usual">
			<div id="tab2" class="tabson">
				<form action="<%=basePath%>/biz/CasCase_patientList.action"
					...
					<ul class="seachform">
						...
						<a href="<%= basePath%>/biz/CasCase_openMessage.action">添加病例</a></li>
					</ul>
				</form>
					...
					<tbody>
						<s:iterator value="pageResult.data" status="status" var="patient">
							...
							<tr>
								...
								<td>${patientCode}</td>
							    <td><a href="<%= basePath%>/biz/CasCase_openMessage.action?patientCode=${patientCode}" class="tablelink">${patientName}</a></td>
...
function change()
  {
 	...
 	if(textfield < totalPage ){
		...
		<script type="text/javascript">
var url = "<%=basePath%>
			/biz/SysUser_list.action"; //获取表单url
			//首页
			function first() {
