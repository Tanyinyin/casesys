                ...
                <ul class="seachform">
                    ...
                    <p:permissions right="addRight">
                        <li class="clickk"><span><img src="<%=path%>/images/t01.png"/></span><a
                                href="<%= basePath%>/biz/SysRight_openAdd.action">添加</a></li>
                    </p:permissions>
                   <li><a style="color: red;line-height: 35px;">警告：非开发人员请勿修改或者删除，否则会造成权限有误的功能无法使用。</a></li> 
                </ul>
            </form>
                        ...
                        <p:permissions menu="deleteRight,editRight">
                            <td>&nbsp;
                                <p:permissions right="editRight">
                                    <a href="<%= basePath%>/biz/SysRight_openEdit.action?rightId=${rightId}"
                                       class="tablelink">修改</a>&nbsp;&nbsp;
                                </p:permissions>
                                <p:permissions right="deleteRight">
                                    <a href="javascript:;" class="tablelinkdelete" style="color: red" idValue="${rightId}">删除</a>&nbsp;&nbsp;
                                </p:permissions>
                            </td>
                        </p:permissions>
                    </tr>
