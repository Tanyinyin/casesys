                ...
                <ul class="seachform">
                    ...
                    <p:permissions right="addRole">
                        <li class="clickk"><span><img src="<%=path%>/images/t01.png"/></span><a
                                href="<%= basePath%>/biz/SysRole_openAdd.action">添加</a></li>
                    </p:permissions>
                        ...
                        <p:permissions menu="deleteRole,editRole">
                            <td>
                                <p:permissions right="editRole">
                                    <a href="<%= basePath%>/biz/SysRole_openEdit.action?roleId=${roleId}"
                                       class="tablelink">修改</a>&nbsp;&nbsp;
                                </p:permissions>
                                <p:permissions right="deleteRole">
                                    <a href="javascript:;" class="tablelinkdelete" style="color: red" roleId="${roleId}"> 删除</a>&nbsp;&nbsp;
                                </p:permissions>
                            </td>
                        </p:permissions>
                    </tr>
